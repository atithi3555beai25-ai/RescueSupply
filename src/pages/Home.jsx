    ...
    <main>
      <section className="hero">
        <div className="hero-content">
          ...
          <p>
            RescueSupply connects restaurants and people with surplus food to
      ...
      <section className="how-it-works">
        <div className="how-header">
          ...
          <p>
            RescueSupply makes it simple for restaurants, NGOs and volunteers to
            turn surplus food into meaningful community impact.
          </p>
        </div>
        <div className="steps">
          {/* Step 01 */}
          <div className="step">
            ...
            <p>
              Restaurants post their safe surplus food with details about meals,
          ...
          <div className="step">
            ...
            <p>
              The donation becomes visible on the RescueSupply map so nearby
              NGOs and volunteers can discover it.
            </p>
          </div>
          ...
          <div className="step">
            ...
            <p>
              An NGO or volunteer accepts the donation and collects the food
              from the restaurant.
            </p>
          </div>
          ...
          <div className="step">
            ...
            <p>
              Rescued food reaches people who need it, turning surplus into
              meaningful support.
            </p>
          </div>
        </div>
      ...
      <section className="cta">
        ...
        <p>
          Don't let good food go to waste. Share it with someone who needs it.
        </p>
